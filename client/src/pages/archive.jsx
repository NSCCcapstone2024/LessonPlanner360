...
export default function ArchivePage() {
    ...
    const handleDeleteCourse = async (courseId) => {
        try {
            ...
            if (response.ok) {
                // Redirect to a page or perform any additional actions after successful deletion
                router.push('/courses');
            } else {
                // Handle error case
            ...
            <div className="bg-gray-100 p-4 rounded-lg shadow-md">
                ...
                <div className="flex flex-col md:flex-row items-center md:items-center space-y-2 md:space-y-0 md:space-x-4">
                    <button
                        ...
                        onClick={() => handleRestoreCourse(id)}>
                        Restore
                    </button>
                    <button
                        className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded w-full md:w-auto mt-2 md:mt-0"
