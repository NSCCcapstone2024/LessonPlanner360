...
export default function Lessons() {
    ...
    const getBackgroundColor = (unitNumber) => {
        if (theme === 'dark') {
            const darkColors = ["bg-gray-600", "bg-pink-600", "bg-blue-600", "bg-green-600", "bg-yellow-600", "bg-indigo-600", "bg-red-600", "bg-purple-600", "bg-cyan-600", "bg-rose-600"];
            return darkColors[unitNumber % darkColors.length];
        } else {
            const lightColors = ["bg-slate-300", "bg-pink-300", "bg-blue-300", "bg-green-300", "bg-yellow-300", "bg-indigo-300", "bg-red-300", "bg-purple-300", "bg-cyan-300", "bg-rose-300"];
    ...
    return (
        <div className={`container mx-auto px-4 pt-8`}>
            ...
            <div className={`flex justify-between items-center mb-6 ${theme === 'dark' ? 'dark' : ''}`}>
                ...
                <div title="Add lesson">
                    <Icon icon="bx:bxs-plus-circle" className="h-8 w-8 text-gray-500 cursor-pointer mr-8" width="24" height="24" onClick={handleAddLesson} />
                </div>
            </div>
                        ...
                        <div className="mt-2">
                            {lessons[unit].map((lesson) => (
                                <div key={lesson.id} className={`${getBackgroundColor(index)} p-2 rounded-lg mb-2 relative`}>
                                    <span className={`status-label ${theme === 'dark'
                                        ? lesson.status === 'prepped' ? 'bg-green-700' : lesson.status === 'completed' ? 'bg-yellow-700' : 'bg-blue-800'
                                        : lesson.status === 'prepped' ? 'bg-green-400' : lesson.status === 'completed' ? 'bg-yellow-400' : 'bg-blue-500'
                                    ...
                                    <div className="flex justify-end space-x-2 absolute top-0 right-0 p-2">
                                        ...
                                        <div
                                            ...
                                            style={{ color: theme === 'dark' ? 'white' : 'red' }}
                                        >
            ...
            {isPopupOpen && (
                <div className={`fixed top-0 left-0 w-full h-full bg-opacity-50 flex justify-center items-center`}>
                    <div className={`bg-${theme === 'dark' ? 'gray-800' : 'gray-300'} p-20 rounded-lg overflow-y-auto max-h-[90vh] ${theme === 'dark' ? 'text-white' : 'text-black'}`}>
                        ...
                        <div className="mb-6">
                            <label htmlFor="week" className="block text-sm font-medium mb-1">Week</label>
                            <span className='text-black'>
                    ...
                    <div className={`bg-${theme === 'dark' ? 'gray-800' : 'gray-300'} p-20 rounded-lg overflow-y-auto max-h-[90vh] ${theme === 'dark' ? 'text-white' : 'text-black'}`}>
                        ...
                        <div className="mb-6">
                            ...
                            <input
                                ...
                                onChange={handleEditInputChange}
                                className="border-gray-300 text-gray-900 border rounded-md p-2 block w-full"
                            />
                        </div>
                        <div className="mb-6">
                            <label htmlFor="learning_outcomes" className="block text-sm font-medium mb-1">Learning Outcomes</label>
                            <input
                                ...
                                onChange={handleEditInputChange}
                                className="border-gray-300 text-gray-900 border rounded-md p-2 block w-96"
                            />
                        </div>
                        <div className="mb-6">
                            <label htmlFor="enabling_outcomes" className="block text-sm font-medium mb-1">Enabling Outcomes</label>
                        ...
                        <div className="mb-6">
                            ...
                            <textarea
                                ...
                                onChange={handleEditInputChange}
                                className="border-gray-300 text-gray-900 border rounded-md p-2 block w-96 h-32 resize-vertical"
                            />
                        </div>
                        <div className="mb-6 border-2 border-gray-200 rounded p-3">
                            <label className="block text-sm font-medium mb-1">Status:</label>
